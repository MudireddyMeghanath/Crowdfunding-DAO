       ...
       dark:shadow-gray-500 rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <form className="flex flex-col">
          ...
          <div className="flex flex-row justify-between items-center border border-gray-500
           dark:border-gray-500 rounded-xl mt-5">
            <input
              ...
              focus:outline-none px-2 focus:ring-0"
              type="text"
              name="title"
              placeholder="Title"
          ...
          <div className="flex flex-row justify-between items-center border border-gray-500
           dark:border-gray-500 rounded-xl mt-5">
            <input
              className="block px-2 w-full text-sm
              bg-transparent border-0
              focus:outline-none delay-150   focus:ring-0"
              type="text"
              name="amount"
          ...
          <div className="flex flex-row justify-between items-center border border-gray-500
           dark:border-gray-500 rounded-xl mt-5">
            <textarea
              ...
              bg-transparent border-0
              focus:outline-none px-2  focus:ring-0 h-20"
              type="text"
              name="description"
